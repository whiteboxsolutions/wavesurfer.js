...
import FFT, { hzToScale, createFilterBankForScale, applyFilterBank, setupColorMap, freqType, unitType, getLabelFrequency, createWrapperClickHandler, } from '../fft.js';
/**
...
class SpectrogramPlugin extends BasePlugin {
    ...
    constructor(options) {
        ...
        this.renderThrottleMs = 50; // Reduced frequency for better performance
        this.zoomThreshold = 0.05; // More sensitive zoom detection
        this.drawnCanvases = {};
    ...
    getFrequenciesData() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const decodedData = (_a = this.wavesurfer) === null || _a === void 0 ? void 0 : _a.getDecodedData();
            if (!decodedData) {
                return null;
            }
            if (this.cachedBuffer === decodedData && this.cachedFrequencies) {
                ...
                const frequencies = yield this.getFrequencies(decodedData);
    ...
    createSingleCanvas(width, height, offset) {
    ...
    throttledRender() {
        ...
        const currentZoom = ((_a = this.wavesurfer) === null || _a === void 0 ? void 0 : _a.options.minPxPerSec) || 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (this.frequenciesDataUrl) {
                    yield this.loadFrequenciesData(this.frequenciesDataUrl);
                }
                else {
                    const decodedData = (_a = this.wavesurfer) === null || _a === void 0 ? void 0 : _a.getDecodedData();
                    if (decodedData) {
                        const frequencies = yield this.getFrequenciesData();
                        this.drawSpectrogram(this.cachedFrequencies);
                    }
                }
                this.lastZoomLevel = ((_b = this.wavesurfer) === null || _b === void 0 ? void 0 : _b.options.minPxPerSec) || 0;
            }
            finally {
                this.isRendering = false;
            }
    ...
    fastRender() {
        ...
        try {
            ...
            this.drawSpectrogram(this.cachedFrequencies);
            this.lastZoomLevel = ((_a = this.wavesurfer) === null || _a === void 0 ? void 0 : _a.options.minPxPerSec) || 0;
        }
        finally {
            this.isRendering = false;
        }
    ...
    drawSpectrogram(frequenciesData) {
        ...
        let resampledData;
        const originalDataWidth = ((_a = frequenciesData[0]) === null || _a === void 0 ? void 0 : _a.length) || 0;
        ...
        const freqFrom = ((_b = this.buffer) === null || _b === void 0 ? void 0 : _b.sampleRate) ? this.buffer.sampleRate / 2 : (this.options.sampleRate || 0) / 2;
        ...
        const drawCanvas = (canvasIndex) => {
            if (canvasIndex < 0 || canvasIndex >= numCanvases)
                return;
            if (this.drawnCanvases[canvasIndex])
                return;
            ...
            for (let c = 0; c < resampledData.length; c++) {
                this.drawSpectrogramSegment(resampledData[c], ctx, canvasWidth, this.height, c * this.height, offset, totalWidth, freqFrom, freqMin, freqMax);
            }
        };
        ...
        if (!this.isScrollable || numCanvases <= 3) {
            ...
            const wrapper = (_c = this.wavesurfer) === null || _c === void 0 ? void 0 : _c.getWrapper();
            if (wrapper) {
    ...
    drawSpectrogramSegment(resampledPixels, ctx, canvasWidth, height, yOffset, xOffset, totalWidth, freqFrom, freqMin, freqMax) {
        ...
        const bitmapPromise = createImageBitmap(imageData, 0, Math.round(bitmapHeight * (1 - rMax1)), segmentWidth, Math.round(bitmapHeight * (rMax1 - rMin)));
    ...
    getWrapperWidth() {
        var _a, _b;
        return ((_b = (_a = this.wavesurfer) === null || _a === void 0 ? void 0 : _a.getWrapper()) === null || _b === void 0 ? void 0 : _b.clientWidth) || 0;
    }
    calculateFrequenciesWithWorker(buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            if (!this.worker) {
    ...
    getFrequencies(buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.useWebWorker && this.worker) {
                try {
                    return yield this.calculateFrequenciesWithWorker(buffer);
                }
                catch (error) {
    ...
    efficientResample(frequenciesData, targetWidth) {
        return frequenciesData.map((channelFreq) => this.resampleChannel(channelFreq, targetWidth));
    }
    resampleChannel(oldMatrix, targetWidth) {
        var _a;
        const oldColumns = oldMatrix.length;
        const freqBins = ((_a = oldMatrix[0]) === null || _a === void 0 ? void 0 : _a.length) || 0;
...
SpectrogramPlugin.MAX_CANVAS_WIDTH = 30000;
SpectrogramPlugin.MAX_NODES = 10;
